        ...
        <div className="flex-1 flex flex-col gap-3 items-start">
          ...
          <img
            ...
            src={
              ...
              "https://img.freepik.com/premium-vector/default-image-image-icon-vector-missing-picture-page-website-design-mobile-app-no-photo-avaliable_87543-11093.jpg"
            }
            alt="icon"
          />
          <Label
