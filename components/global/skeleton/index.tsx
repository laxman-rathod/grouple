...
type Props = { element: "CARD" | "POST" }

export const Skeleton = ({ element }: Props) => {
  switch (element) {
    case "CARD":
      return (
    ...
    case "POST":
      return (
        <div className="w-full pt-4 text-white rounded-lg overflow-hidden bg-[#1C1C1E] border border-[#27272A]">
          <div className="flex items-center mb-3 px-4">
            <SkeletonUI className="w-12 h-12 mr-4 rounded-full bg-[#202020]" />
            <div>
              <SkeletonUI className="h-5 w-24 rounded-md bg-[#202020]" />
